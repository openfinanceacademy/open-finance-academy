...
No prior finance knowledge is needed. New finance terms are **bold**, explained on first use, and linked to the glossary. Its definitions link back to this lesson.
...
1. [Separate rules from ethical judgment](#separate-rules-from-ethical-judgment)
2. [Check who provides the service](#check-who-provides-the-service)
3. [Read the terms and calculate the cost](#read-the-terms-and-calculate-the-cost)
4. [Recognize conflicts of interest](#recognize-conflicts-of-interest)
5. [Spot deception and respond to scams](#spot-deception-and-respond-to-scams)
6. [Protect privacy and fair access](#protect-privacy-and-fair-access)
7. [Document and resolve a problem](#document-and-resolve-a-problem)
8. [Design services people can use](#design-services-people-can-use)
...
**[Financial regulation]({{ '/glossary/' | relative_url }}#financial-regulation)** is the system of rules governing financial activities and firms. **[Supervision]({{ '/glossary/' | relative_url }}#supervision)** is oversight of firms to assess their behavior, risks, and adherence to applicable rules. **[Compliance]({{ '/glossary/' | relative_url }}#compliance)** means meeting applicable legal and regulatory requirements.

**[Financial ethics]({{ '/glossary/' | relative_url }}#financial-ethics)** concerns responsible conduct in financial decisions, including honesty, fairness, and the interests of people affected. **[Consumer protection]({{ '/glossary/' | relative_url }}#consumer-protection)** includes rules and practices intended to prevent unfair treatment and provide ways to address harm.
...
A **[regulatory register]({{ '/glossary/' | relative_url }}#regulatory-register)** is an official listing that can help check a firm's or individual's regulatory status and permitted activities. An entry is not an endorsement of investment quality or a promise that losses cannot occur.
...
A **[disclosure]({{ '/glossary/' | relative_url }}#disclosure)** is information provided about a product, service, or relationship, such as its costs, risks, restrictions, and conflicts. A readable summary helps you compare, but the agreement may contain additional conditions.
...
A **[conflict of interest]({{ '/glossary/' | relative_url }}#conflict-of-interest)** exists when a person's or firm's interests could influence how they serve someone else's interests. A **[commission]({{ '/glossary/' | relative_url }}#commission)** is compensation tied to a sale or transaction.
...
- Product A compensation: $10,000 × 0.01 = **$100**.
- Product B compensation: $10,000 × 0.04 = **$400**.
- Additional compensation for selling B: $400 − $100 = **$300**.
...
**[Fraud]({{ '/glossary/' | relative_url }}#fraud)** is intentional deception used to obtain money or property unlawfully. **[Phishing]({{ '/glossary/' | relative_url }}#phishing)** is an attempt to trick someone into revealing information or taking an action by impersonating a trusted source.
...
**[Financial privacy]({{ '/glossary/' | relative_url }}#financial-privacy)** concerns how information about someone's money and financial activity is collected, used, shared, and protected. **[Personal data]({{ '/glossary/' | relative_url }}#personal-data)** is information relating to an identified or identifiable person.
...
A **[consumer complaint]({{ '/glossary/' | relative_url }}#consumer-complaint)** communicates dissatisfaction about a product, service, or treatment and seeks a response. **[Redress]({{ '/glossary/' | relative_url }}#redress)** is action to put a problem right, such as correcting a record or refunding an improper charge. The appropriate remedy depends on the facts and applicable rules.
...
- Expected charges: $3 × 4 = **$12**.
- Actual charges: $7 × 4 = **$28**.
- Difference to investigate: $28 − $12 = **$16**.
