...
permalink: /knowledge/international-finance/
glossary_terms:
  exchange-rate: read-an-exchange-rate
  foreign-exchange: read-an-exchange-rate
  currency-appreciation: understand-a-currency-movement
  currency-depreciation: understand-a-currency-movement
  floating-exchange-rate: understand-a-currency-movement
  fixed-exchange-rate: understand-a-currency-movement
  currency-risk: measure-an-overseas-investment
  hedging: manage-a-future-foreign-currency-bill
  forward-contract: manage-a-future-foreign-currency-bill
  exports: connect-trade-and-financial-flows
  imports: connect-trade-and-financial-flows
  balance-of-payments: connect-trade-and-financial-flows
  current-account: connect-trade-and-financial-flows
  capital-account: connect-trade-and-financial-flows
  financial-account: connect-trade-and-financial-flows
  trade-balance: connect-trade-and-financial-flows
  foreign-direct-investment: connect-trade-and-financial-flows
  portfolio-investment: connect-trade-and-financial-flows
  sovereign-risk: assess-country-and-borrowing-risks
  capital-controls: assess-country-and-borrowing-risks
  emerging-markets: assess-country-and-borrowing-risks
...
No prior finance knowledge is needed. New finance terms are **bold**, explained on first use, and linked to the glossary. Each glossary entry links back to its explanation here.
...
1. [Read an exchange rate](#read-an-exchange-rate)
2. [Understand a currency movement](#understand-a-currency-movement)
3. [Measure an overseas investment](#measure-an-overseas-investment)
4. [Manage a future foreign-currency bill](#manage-a-future-foreign-currency-bill)
5. [Connect trade and financial flows](#connect-trade-and-financial-flows)
6. [Work through an economy's accounts](#work-through-an-economys-accounts)
7. [Assess country and borrowing risks](#assess-country-and-borrowing-risks)
8. [Understand development finance](#understand-development-finance)
9. [Check your understanding](#check-your-understanding)

## Read an exchange rate

Suppose a course abroad costs €800, but your money is in U.S. dollars. An **[exchange rate]({{ '/glossary/' | relative_url }}#exchange-rate)** is the price of one currency expressed in another. **[Foreign exchange]({{ '/glossary/' | relative_url }}#foreign-exchange)** means exchanging one currency for another, or the markets where those exchanges occur.
...
**[Currency appreciation]({{ '/glossary/' | relative_url }}#currency-appreciation)** means a currency gains value relative to another. **[Currency depreciation]({{ '/glossary/' | relative_url }}#currency-depreciation)** means it loses value relative to another. This use of “depreciation” differs from allocating an asset's cost in accounting.
...
**[Currency risk]({{ '/glossary/' | relative_url }}#currency-risk)** is the possibility that exchange-rate changes alter the value of an investment, payment, or obligation measured in the currency you use.
...
**[Exports]({{ '/glossary/' | relative_url }}#exports)** are goods and services residents sell to nonresidents; **[imports]({{ '/glossary/' | relative_url }}#imports)** are goods and services they buy from nonresidents. The distinction uses economic residence, not citizenship.

The **[balance of payments]({{ '/glossary/' | relative_url }}#balance-of-payments)** records an economy's transactions with the rest of the world over a period. It includes more than money physically crossing a border.

| Account | What it records |
| --- | --- |
| **[Current account]({{ '/glossary/' | relative_url }}#current-account)** | Trade in goods and services, income such as cross-border interest and earnings, and current transfers such as many household transfers. |
...
**[Sovereign risk]({{ '/glossary/' | relative_url }}#sovereign-risk)** is the risk that a government will fail to meet its debt obligations as agreed. The currency of the debt matters as well as its amount and payment dates.
