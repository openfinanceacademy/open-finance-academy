...
permalink: /knowledge/financial-markets-and-instruments/
glossary_terms:
  financial-market: why-financial-markets-exist
  financial-instrument: why-financial-markets-exist
  primary-market: why-financial-markets-exist
  secondary-market: why-financial-markets-exist
  face-value: compare-the-main-instruments
  coupon: compare-the-main-instruments
  maturity: compare-the-main-instruments
  money-market: compare-the-main-instruments
  treasury-bill: compare-the-main-instruments
  commercial-paper: compare-the-main-instruments
  commodity: compare-the-main-instruments
  current-yield: read-a-bond-price-and-yield
  exchange: understand-quotes-and-trading-costs
  broker: understand-quotes-and-trading-costs
  market-maker: understand-quotes-and-trading-costs
  bid-price: understand-quotes-and-trading-costs
  ask-price: understand-quotes-and-trading-costs
  bid-ask-spread: understand-quotes-and-trading-costs
  price-discovery: understand-quotes-and-trading-costs
  market-order: choose-what-an-order-controls
  limit-order: choose-what-an-order-controls
  stop-order: choose-what-an-order-controls
  derivative: distinguish-derivative-contracts
  forward-contract: distinguish-derivative-contracts
  futures-contract: distinguish-derivative-contracts
  option: distinguish-derivative-contracts
  swap: distinguish-derivative-contracts
  hedging: distinguish-derivative-contracts
  call-option: work-through-an-option-payoff
  put-option: work-through-an-option-payoff
  strike-price: work-through-an-option-payoff
  option-premium: work-through-an-option-payoff
  leverage: see-how-leverage-changes-losses
  margin: see-how-leverage-changes-losses
  margin-call: see-how-leverage-changes-losses
  stock: compare-the-main-instruments
  dividend: compare-the-main-instruments
  bond: compare-the-main-instruments
...
No trading experience is needed. Basic percentages help. [Investing and portfolio management]({{ '/knowledge/investing-and-portfolio-management/' | relative_url }}) introduces investment choices in the context of goals and risk. New terms are **bold**, explained on first use, and linked to the glossary; each definition links back to its lesson references.
...
1. [Why financial markets exist](#why-financial-markets-exist)
2. [Compare the main instruments](#compare-the-main-instruments)
3. [Read a bond price and yield](#read-a-bond-price-and-yield)
4. [Understand quotes and trading costs](#understand-quotes-and-trading-costs)
5. [Choose what an order controls](#choose-what-an-order-controls)
6. [Distinguish derivative contracts](#distinguish-derivative-contracts)
7. [Work through an option payoff](#work-through-an-option-payoff)
8. [See how leverage changes losses](#see-how-leverage-changes-losses)
9. [Read the terms before comparing prices](#read-the-terms-before-comparing-prices)
...
A **[commodity]({{ '/glossary/' | relative_url }}#commodity)** is a basic physical good, such as wheat, oil, or copper. Owning the physical good can involve storage and delivery costs. A financial contract referencing its price is a different holding from owning the good itself.
...
**[Current yield]({{ '/glossary/' | relative_url }}#current-yield)** divides the annual coupon payment by the current market price:
...
- **[Bid price]({{ '/glossary/' | relative_url }}#bid-price)**: **$49.90**, the price a buyer offers to pay.
...
**[Liquidity]({{ '/glossary/' | relative_url }}#liquidity)** means how easily and quickly a holding can become spendable money without a large loss in value. Wider spreads or little quantity available can make trading more costly. An instrument can be easy to sell while its price changes sharply. During stressed conditions, available trading quantity may shrink just when holders most want to sell.
...
| --- | --- | --- |
| **[Market order]({{ '/glossary/' | relative_url }}#market-order)** | Buy or sell at the best available prices when executed. | No specific price is guaranteed. A large order may fill at several prices. |
...
A **[derivative]({{ '/glossary/' | relative_url }}#derivative)** is a contract whose value or payments depend on an asset, price, rate, or other reference. Read the obligation rather than assuming every derivative works like buying a share.

| Contract | Basic obligation |
| --- | --- |
| **[Forward contract]({{ '/glossary/' | relative_url }}#forward-contract)** | Parties agree today on a price for a future purchase or sale, often using a customized private agreement. |
| **[Futures contract]({{ '/glossary/' | relative_url }}#futures-contract)** | A standardized exchange-traded agreement for future delivery or cash settlement, with gains and losses generally settled daily. |
...
A **[call option]({{ '/glossary/' | relative_url }}#call-option)** gives its buyer the right to buy; a **[put option]({{ '/glossary/' | relative_url }}#put-option)** gives the right to sell. The **[strike price]({{ '/glossary/' | relative_url }}#strike-price)** is the agreed exercise price. The **[option premium]({{ '/glossary/' | relative_url }}#option-premium)** is the price paid for the option.
...
**[Leverage]({{ '/glossary/' | relative_url }}#leverage)** uses borrowing or contracts to create exposure larger than the money initially committed. Suppose you contribute **$500** and borrow **$500** to buy **$1,000 of shares**. Ignore loan interest and fees, and assume the loan balance stays $500:
...
- **Claim or obligation:** ownership, promised repayment, a right, or a duty to trade?
- **Quantity and timing:** how many units, what payment dates, and when does the agreement end?
- **Exit conditions:** can it be sold, at what spread, and with what transfer delay?
- **Cash demands:** fees, borrowing charges, margin requirements, or exercise funding?
- **Failure scenarios:** price changes, a party failing to pay, or difficulty exiting?
...
Continue with [Investing and portfolio management]({{ '/knowledge/investing-and-portfolio-management/' | relative_url }}) to connect instrument choices with goals, diversification, and costs. [Banking, credit, and lending]({{ '/knowledge/banking-credit-and-lending/' | relative_url }}) explains deposits and borrowing. [Payments and money movement]({{ '/knowledge/payments-and-money-movement/' | relative_url }}) develops clearing and settlement in payment systems.

Use [Accounting and financial analysis]({{ '/knowledge/accounting-and-financial-analysis/' | relative_url }}) to examine an issuer's financial statements, and [Books]({{ '/books/' | relative_url }}) for further reading.

### Planned follow-up lessons

- Comparing bond yields across maturities and quotation conventions
- Reading order books, trade confirmations, and settlement details
