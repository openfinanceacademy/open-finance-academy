---
layout: default
title: Sustainable finance and financial inclusion
permalink: /knowledge/sustainable-finance-and-financial-inclusion/
glossary_terms:
  sustainable-finance: two-questions-for-finance
  financial-inclusion: two-questions-for-finance
  financial-exclusion: access-to-basic-services
  unbanked: access-to-basic-services
  underbanked: access-to-basic-services
  bank: access-to-basic-services
  payday-loan: the-cost-of-small-loans
  annual-percentage-rate: the-cost-of-small-loans
  credit-union: community-finance-and-microfinance
  cooperative: community-finance-and-microfinance
  microfinance: community-finance-and-microfinance
  climate-risk: climate-risk-and-finance
  physical-risk: climate-risk-and-finance
  transition-risk: climate-risk-and-finance
  insurance-premium: climate-risk-and-finance
  sustainable-investing: sustainable-investing-and-its-labels
  esg: sustainable-investing-and-its-labels
  green-bond: sustainable-investing-and-its-labels
  impact-investing: sustainable-investing-and-its-labels
  greenwashing: when-claims-do-not-match-reality
  poverty-premium: unequal-outcomes-and-the-poverty-premium
---
...
No prior finance knowledge is needed, though [Money and financial fundamentals]({{ '/knowledge/money-and-financial-fundamentals/' | relative_url }}) introduces interest and rates used in the loan comparisons. New finance terms are **bold**, explained on first use, and linked to the glossary. Each glossary entry links back to its explanation here.
...
1. [Two questions for finance](#two-questions-for-finance)
2. [Access to basic services](#access-to-basic-services)
3. [The cost of small loans](#the-cost-of-small-loans)
4. [Community finance and microfinance](#community-finance-and-microfinance)
5. [Climate risk and finance](#climate-risk-and-finance)
6. [Sustainable investing and its labels](#sustainable-investing-and-its-labels)
7. [When claims do not match reality](#when-claims-do-not-match-reality)
8. [Unequal outcomes and the poverty premium](#unequal-outcomes-and-the-poverty-premium)
...
- Fee per month: $1,200 × 0.02 = **$24**
- Fees per year: $24 × 12 = **$288**
- Three money orders a month for bills, at $2 each: $6 × 12 = **$72**
- Total: **$360 a year**, before counting the time spent queuing or the risks of holding cash.
...
Exclusion gets more expensive when borrowing enters the picture. A **[payday loan]({{ '/glossary/' | relative_url }}#payday-loan)** is a small, short-term loan typically due in full on the borrower's next payday, with fees that imply a high annualized cost. Compare two invented ways to borrow $400:

| | Payday-style loan | Credit-union-style loan |
| --- | --- | --- |
| Amount borrowed | $400 | $400 |
| Terms | $60 fee every 2 weeks, renewed when the borrower cannot repay | 18% **[annual percentage rate]({{ '/glossary/' | relative_url }}#annual-percentage-rate)** over 3 months |
...
The effects question starts with risk that is already arriving on balance sheets. **[Climate risk]({{ '/glossary/' | relative_url }}#climate-risk)** is the possibility of financial loss arising from climate change, and it reaches households and lenders through two channels.
...
On the investing side, **[sustainable investing]({{ '/glossary/' | relative_url }}#sustainable-investing)** covers approaches that consider environmental or social effects alongside financial return. Within it, three labels recur:

| Label | What it claims | What to check |
| --- | --- | --- |
| **[Environmental, social, and governance (ESG)]({{ '/glossary/' | relative_url }}#esg)** | A fund or rating evaluates companies on environmental, social, and governance factors. | Which factors, measured how, by whom? Providers rate the same company differently. |
...
- A fund renamed with a "green" or "responsible" label while its largest holdings stay unchanged.
- A sustainability claim with no stated method: no definition, no measurement, no date.
- A reported benefit with no comparison — "financed 10,000 solar panels" without saying what would have happened anyway.
- Goals set far in the future with no interim milestones or budget attached.
