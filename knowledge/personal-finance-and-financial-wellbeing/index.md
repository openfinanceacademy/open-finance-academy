---
layout: default
title: Personal finance and financial wellbeing
permalink: /knowledge/personal-finance-and-financial-wellbeing/
glossary_terms:
  personal-finance: what-financial-wellbeing-means
  financial-wellbeing: what-financial-wellbeing-means
  income: make-a-plan-for-the-money-coming-in
  take-home-pay: make-a-plan-for-the-money-coming-in
  expense: make-a-plan-for-the-money-coming-in
  budget: make-a-plan-for-the-money-coming-in
  cash-flow: check-when-money-arrives-and-leaves
  emergency-fund: save-for-surprises-and-known-costs
  sinking-fund: save-for-surprises-and-known-costs
  liquidity: save-for-surprises-and-known-costs
  debt: understand-and-organize-debt
  principal: understand-and-organize-debt
  interest: understand-and-organize-debt
  minimum-payment: understand-and-organize-debt
  debt-avalanche: understand-and-organize-debt
  debt-snowball: understand-and-organize-debt
  credit: understand-credit-reports-and-scores
  credit-report: understand-credit-reports-and-scores
  credit-score: understand-credit-reports-and-scores
  credit-limit: understand-credit-reports-and-scores
  credit-utilization: understand-credit-reports-and-scores
  financial-goal: turn-future-goals-into-amounts
  retirement: turn-future-goals-into-amounts
  pension: turn-future-goals-into-amounts
  contribution: turn-future-goals-into-amounts
  employer-match: turn-future-goals-into-amounts
  vesting: turn-future-goals-into-amounts
  estate-planning: plan-for-help-and-major-life-changes
  will: plan-for-help-and-major-life-changes
...
No prior knowledge is required. [Money and financial fundamentals]({{ '/knowledge/money-and-financial-fundamentals/' | relative_url }}) offers extra practice with interest and inflation. New terms are **bold**, explained as they appear, and linked to the glossary. Each glossary entry links back to its explanation here.
...
1. [What financial wellbeing means](#what-financial-wellbeing-means)
2. [Make a plan for the money coming in](#make-a-plan-for-the-money-coming-in)
3. [Check when money arrives and leaves](#check-when-money-arrives-and-leaves)
4. [Save for surprises and known costs](#save-for-surprises-and-known-costs)
5. [Understand and organize debt](#understand-and-organize-debt)
6. [Understand credit reports and scores](#understand-credit-reports-and-scores)
7. [Turn future goals into amounts](#turn-future-goals-into-amounts)
8. [Plan for help and major life changes](#plan-for-help-and-major-life-changes)
9. [Build a routine you can keep](#build-a-routine-you-can-keep)
...
An **[emergency fund]({{ '/glossary/' | relative_url }}#emergency-fund)** is money set aside for unexpected costs or lost income. A **[sinking fund]({{ '/glossary/' | relative_url }}#sinking-fund)**, in household budgeting, is money gradually set aside for a **known future cost**. An annual bill is predictable even though it does not arrive every month.
...
**[Debt]({{ '/glossary/' | relative_url }}#debt)** is money owed that must be repaid. **[Principal]({{ '/glossary/' | relative_url }}#principal)** is the amount borrowed, separate from interest; as you repay it, the remaining principal shrinks. **[Interest]({{ '/glossary/' | relative_url }}#interest)** is the cost charged for using borrowed money.

Start by listing each amount owed, its interest rate, due date, fees, and required payment. A **[minimum payment]({{ '/glossary/' | relative_url }}#minimum-payment)** is the smallest amount a lender requires for a billing period. Paying only that amount can leave money owed for a long time.
...
A **[financial goal]({{ '/glossary/' | relative_url }}#financial-goal)** is a desired outcome involving money. An amount and date make it easier to plan: “Save $900 for a course in nine months” means **$900 ÷ 9 = $100 a month**, assuming you start at zero and earn no interest. Compare that amount with the budget before committing to the deadline.
...
**[Estate planning]({{ '/glossary/' | relative_url }}#estate-planning)** means preparing for who will manage your affairs if you cannot and how your money and property will be handled after death. It is useful even when there is little money involved.
...
1. Sam receives $2,400 and assigns $2,250, including savings. How much is still unassigned? Is all of it automatically available to spend?
2. You have $250 today, a $600 bill tomorrow, and a paycheck next week. What is the immediate shortfall?
3. An annual bill of $720 is due in six months. You already have $120 set aside. How much must you save each month, assuming six deposits before it is due?
4. One debt has a $400 balance at 10% annual interest; another has a $900 balance at 20%. After required payments, which gets the extra payment under each repayment approach?
5. A reported card balance is $240 and its limit is $1,200. What is its utilization? Does this tell you an exact credit score?
6. A fictional retirement plan matches half of the first $80 you contribute each month. If you contribute $80, how much goes into the account before fees or investment changes?
7. Does naming someone as an emergency contact automatically let them manage your money?

### Answers

1. **$150:** $2,400 − $2,250. First check for missing costs and upcoming needs before deciding how to use it.
2. **$350:** $600 − $250. The timing problem exists even if next week's paycheck is larger than the bill.
3. **$100 a month:** ($720 − $120) ÷ 6. This is a sinking fund because the cost and deadline are known.
4. **Avalanche: the $900 debt at 20%. Snowball: the $400 debt.** One orders debts by rate, the other by balance; both maintain required payments elsewhere.
5. **20%:** $240 ÷ $1,200 × 100. No: a score depends on other information and the scoring model too.
6. **$120:** your $80 plus the employer's $40. Check vesting before assuming you can keep all employer money if you leave.
7. **No.** A contact person and someone with legal authority have different roles. The required arrangements depend on local law and the account.
