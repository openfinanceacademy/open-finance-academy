...
- **Transparent payout policy.** Realized gains, not principal, fund the grant programs — see the [Financial Empowerment Grant Program]({{ '/projects/financial-empowerment-grant-program/' | relative_url }}) — under a published annual spending policy, so contributors can see exactly how their pooled dollars translate into support delivered.
